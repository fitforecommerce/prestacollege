<div class="moduleconfig-content">
  ...
  <div class="row">
    <form id="module_form" class="defaultForm form-horizontal"  action="{$form_action_url}" method="post" enctype="multipart/form-data" novalidate="">
      ...
      <div class="row">
        <label for="dbsnapshotcurlurl" class="control-label col-lg-4">{l s='Enter download url'}</label>
        <div class="col-lg-6">
          <input type="text" name="dbsnapshotcurlurl" >
        </div>
      </div>
      <input type="submit" value="Download database snapshot" class="btn btn-default pull-right">
    </form>
  </div>  
